...
public class TinyDB {
    ...
    public ArrayList<MyEvent> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<MyEvent> objects =  new ArrayList<MyEvent>();

    	for(String jObjString : objStrings){
    		MyEvent value  = (MyEvent) gson.fromJson(jObjString, mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<MyEvent> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
